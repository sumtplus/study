...
### 10. 소감
이번 프로젝트를 하면서 온라인 교육 사이트에는 어떤 기능들이 필요할지 사용자입장에서 많이 고민해보는 시간이었습니다. 또 학원에서 수업을 들으면서 사이트를 개발하다보니 스프링의 특징인 AOP와 IOC에 대해 잘 이해할 수 있었습니다. 또한 스프링 security를 이용한 회원처리와 rest방식의 댓글처리를 하는 것은 좋은 경험이었습니다. 아쉬운 점은 원래 목표로 하는 기능을 다하지 못한 것입니다. 앞으로 조금 더 시간을 내서 관리자기능이나 네이버로그인, 별점 등 많은 기능에 도전하고 싶고 프로젝트의 완성도를 높이고 싶습니다.
